%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% VAR estimation with COVID volatility.
% Estimation sample ends in June 2020.
% Forecasts are produced starting in July 2020. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
T1estim = find(year(TimeMACRO)==2020 & month(TimeMACRO)==6);    % end of estimation sample

T1av = find(year(TimeMACRO)==2020 & month(TimeMACRO)==6);       % date of last available data for forecasting
...
Tcovid=Tfeb2020-T0+2;                                           % first time period of COVID (March 2020; should be set to [] if constant volatility)
...
% conditioning scenario based on ex-post realizations of unemployment and Blue Chip forecasts as of May 2021
YYfcst(end-hmax+1:end,1)=[100*log(DataMACRO(T1av+1:end-1,indmacro(1)));4+(5.8-4)*.85.^[0:hmax-11]'];
